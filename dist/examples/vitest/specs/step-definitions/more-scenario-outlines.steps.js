...
var feature = (0, src_1.loadFeature)('./examples/typescript/specs/features/more-scenario-outlines.feature');
(0, src_1.defineFeature)(feature, function (test) {
    ...
    var thenIShouldGetXAsTheAnswer = function (then) {
        then(/^I should get (.*) as the answer$/, function (expectedSolution) {
            (0, vitest_1.expect)(solution).toBe(expectedSolution);
        });
    };
    test('Solving series', function (_a) {
        ...
        given(/^I have a series (.*) (.*) (.*) (.*) (.*) (.*) (.*)$/, function (firstTerm, firstOperator, secondTerm, secondOperator, thirdTerm, thirdOperator, forthTerm) {
            (0, vitest_1.expect)(firstOperator).toStrictEqual(secondOperator);
            (0, vitest_1.expect)(firstOperator).toStrictEqual(thirdOperator);
    ...
    test('Adding series', function (_a) {
        ...
        given(/^I add the following series:$/, function (table) {
            var row = table[0];
            terms = row.Series.split(" ".concat(row.Operator, " "));
