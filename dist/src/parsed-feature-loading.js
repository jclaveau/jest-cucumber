...
var multiline_table_cells_1 = require("./multiline-table-cells");
...
var parseStepArgument = function (astStep) {
    if (astStep === null || astStep === void 0 ? void 0 : astStep.dataTable) {
        return parseDataTable(astStep.dataTable);
    }
    if (astStep === null || astStep === void 0 ? void 0 : astStep.docString) {
...
var parseFeature = function (featureText, options) {
    ...
    var foldedFeatureText = (0, multiline_table_cells_1.foldMultilineTableCells)(featureText);
    try {
        var builder = new gherkin_1.AstBuilder(uuid_1.v4);
        var tokenMatcher = new gherkin_1.GherkinClassicTokenMatcher();
        ast = new gherkin_1.Parser(builder, tokenMatcher).parse(foldedFeatureText);
    }
    catch (err) {
...
var loadFeature = function (featureFilePath, options) {
    ...
    var resolveOptions = (0, configuration_1.getJestCucumberConfiguration)(options);
    var absoluteFeatureFilePath = (0, path_1.resolve)(resolveOptions.loadRelativePath ? dirOfCaller : '', featureFilePath);
    try {
        ...
        err.message = "".concat(err.message, " (").concat(absoluteFeatureFilePath, ")");
        throw err;
    }
};
