...
export declare const wireUpMockFeature: (mockTestRunner: MockTestRunner, featureFile: string, mockStepDefinitions: MockStepDefinitions | null, options?: Options) => void;
